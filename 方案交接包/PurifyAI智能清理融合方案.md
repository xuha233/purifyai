...
> **技术决策说明**: 基于 MVP 范围，NTFS MFT 和 Treemap 可视化延后到 V2 版本。
> 详见: [01_MVP实施计划.md](01_MVP实施计划.md)

### 9.1 MVP 与 V2 功能划分

| WinDirStat功能 | MVP | V2 | 说明 |
|---------------|:---:|:---:|------|
| NTFS MFT快速扫描 | ❌ | ✅ | MVP使用基础API，V2添加MFT优化 |
| 基础深度扫描 | ✅ | - | 自定义路径遍历 |
| Treemap可视化 | ❌ | ✅ | MVP用统计列表替代 |
| 硬链接处理 | ⚠️ | ✅ | MVP仅提示，V2完整支持 |
| 文件扩展名统计 | ⚠️ | ✅ | MVP基础统计，V2详细分析 |
| 文件压缩检测 | ❌ | ✅ | V2功能 |
...
| 功能 | 融合方式 | 价值 |
|------|---------|------|
| 基础深度扫描 | 移植为DepthDiskScanner | 支持大型目录扫描 |
| 系统目录跳过 | 参考WinDirStat的排除列表 | 避免误删系统文件 |
| 文件大小聚合 | 继承WinDirStat的聚合逻辑 | 准确计算目录大小 |
